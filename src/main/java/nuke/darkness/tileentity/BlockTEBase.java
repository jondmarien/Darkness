package nuke.darkness.tileentity;
...
public class BlockTEBase extends BlockBase implements ITileEntityProvider {
	...
	public BlockTEBase(Material mat, String name, String toolUsed, int toolStrength, float hardness, float resistance,
	...
	{
		return ((ITileEntityBase) world.getTileEntity(pos)).activate(world, pos, state, player, hand, face, hitX, hitY,
		        hitZ);
	}
