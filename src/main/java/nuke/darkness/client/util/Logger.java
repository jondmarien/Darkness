...
/**
 * Logger class copied from TestMod3's 1.12 Branch
 * @author Choonster
 */
public class Logger {
	public static final Marker MOD_MARKER = MarkerManager.getMarker(Vars.MODID);
	...
	public static void setLogger(final org.apache.logging.log4j.Logger logger) {
		if (Logger.logger != null) { throw new IllegalStateException("Attempt to replace logger"); }
