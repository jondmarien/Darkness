...
public class Recipes {
	...
	public static void init() {
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(Content.book_binding), true,
		        new Object[]
		{ "Ss ", "Ss ", "Ss ", 'S', Items.STICK, 's', Items.STRING }));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(Content.compendium), true,
		        new Object[]
		{ "Bb ", "Bb ", "Bb ", 'B', Content.book_binding, 'b', Items.WRITABLE_BOOK }));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(Content.scroll_bag), true,
		        new Object[]
		{ "   ", "LSL", " L ", 'L', Items.LEATHER, 'S', Items.STRING }));

		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(Content.darkened_string, 9),
		        new Object[]
		 ...
		 * Material Sets
		 */
		Recipes.regMatSet("ingotDarkRunic", "nuggetDarkRunic", "blockDarkRunic", Content.ingot_darkrunic,
		        Content.droplet_darkrunic, Content.block_rune_null, Content.pickaxe_darkrunic, Content.axe_darkrunic,
		        Content.sword_darkrunic, Content.shovel_darkrunic, Content.hoe_darkrunic);
	}
	        ...
	        Block block, Item pickaxe, Item axe, Item sword, Item shovel, Item hoe )
	{
		GameRegistry.addRecipe(
		        new ShapedOreRecipe(new ItemStack(ingot), true, new Object[]
		{ "XXX", "XXX", "XXX", 'X', droplet }));
		GameRegistry.addRecipe(
		        new ShapedOreRecipe(new ItemStack(block), true, new Object[]
		{ "XXX", "XXX", "XXX", 'X', ingot }));
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(axe, 1), true,
		        new Object[]
		{ " XX", " SX", " S ", 'X', ingotKey, 'S', "stickWood" }));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(axe, 1), true,
		        new Object[]
		{ "XX ", "XS ", " S ", 'X', ingotKey, 'S', "stickWood" }));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(sword, 1), true,
		        new Object[]
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(hoe, 1), true,
		        new Object[]
