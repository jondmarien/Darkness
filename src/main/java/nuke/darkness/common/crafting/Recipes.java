...
public class Recipes {
	...
	public static void init() {
		 ...
		 * Material Sets
		 */
		Recipes.regMatSet("ingotDarkRunic", "nuggetDarkRunic", "blockDarkRunic", Content.ingot_darkrunic, Content.droplet_darkrunic, Content.block_rune_null, Content.pickaxe_darkrunic, Content.axe_darkrunic, Content.sword_darkrunic,
