package nuke.darkness.common.item.bauble;
...
public class ItemBaubleBasic extends ItemBasic implements IBauble {
	...
	public ItemBaubleBasic(String name, BaubleType type) {
		super(name);
	}
